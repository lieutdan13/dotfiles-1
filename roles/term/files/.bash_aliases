...
# [ssh]
alias ssh='ssh -i $HOME/.passman_vault/.ssh/id_ed25519 $1'
alias ssh_rsa='ssh -i $HOME/.passman_vault/.ssh/id_rsa $1'
alias ssh_onshift='ssh -i $HOME/.passman_vault/.ssh/id_onshift $1'
